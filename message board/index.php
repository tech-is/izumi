...
if( !empty($_POST['btn_submit']) ) {
    ...
    if( empty($error_message) ) {
		...
		if( $mysqli->connect_errno ) {
			...
			// データを登録するSQL作成
			$sql = "INSERT INTO message (view_name, message, insert_time) VALUES ( '$clean[view_name]', '$clean[message]', '$now_date')";
			// データを登録
...
if( $mysqli->connect_errno ) {
    ...
    // ここにデータを取得する処理が入る
    $sql = "SELECT view_name,message,insert_time FROM message ORDER BY insert_time DESC";
	$res = $mysqli->query($sql);
        ...
        <section >
            ...
            <article>
                <div class="info">
                    ...
                    <time><?php echo date('Y年m月d日 H:i', strtotime($value['insert_time'])); ?></time>
                </div>
