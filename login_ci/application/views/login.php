...
?>
    <div class="container">
        ...
        <div class ="form-group">
            ...
            <input type = "text" name="mail" placeholder = "メールアドレス" class="form-control container">
        </div>
        <!-- パスワード -->
        <div class ="form-group">
            <div class="error">
            ...
            <input type="password" name="pass" placeholder="パスワード" class="form-control container">
        </div>
        <!-- remember -->
