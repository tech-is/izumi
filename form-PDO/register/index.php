...
<body>
  <div class="container">
    <h1>会員登録フォーム</h1>
    <form action="Confilm.php" method="post" name="main" onSubmit="return check(this)">
      ...
      <div class="form-group">
        <label>
          <input type="checkbox" checked name="magazine" value='1' id="magazine">メールマガジン送付する<br>
        </label>
      </div>
      <div class="form-group">
        <input type="submit" class="btn btn-primary" name="confirm" value="登録">
      </div>
    </form>
  </div>
</body>
