...
$mailer->Username = 'hogehoge@gmail.com'; // Gmailのユーザー名
$mailer->Password = 'hoge'; // Gmailのパスワード
...
生まれ年:　{$_POST['year']}年
性別:　{$_POST['sex_name']}
メールマガジン:　{$_POST['magazine']}
本登録は以下のURLをクリックし,仮パスワードを入力してください。
以上で登録は完了です。
仮パスワード:{$pass_tmp}
EOM;
$mailer->From     = 'techis@gmail.com'; //差出人の設定
$mailer->FromName = mb_convert_encoding("tech i.s. 和泉","UTF-8","AUTO");//表示名おまじない付…
