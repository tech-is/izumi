    ...
    <div class="container">
        ...
        <?php foreach($array as $key => $val): ?>
            <div class ="form-group">
                ...
                <input type=text name=<?=$key?> class="form-control container" placeholder=<?=$val?>>
            </div>
        <?php endforeach; ?>
        <div class ="form-group">
        ...
        <div class ="form-group">
            ...
            <input type="radio" name="sex" value="male" checked>男性<input type="radio" name="sex" value="female">女性</p>
        </div>
        <div class ="form-group">
